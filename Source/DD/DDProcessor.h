...
class MetallicDDProcessor : public juce::AudioProcessor
{
public:
    MetallicDDProcessor();
    ~MetallicDDProcessor() override;
    ...
    const juce::String getName() const override { return "Metallic Digital Delay"; }
...
private:
    ...
    juce::dsp::DelayLine<float> tankD1L, tankD1R;
    juce::dsp::DelayLine<float> tankD2L, tankD2R;

    float plateLpL = 0.f, plateLpR = 0.f;
    float plateFbL = 0.f, plateFbR = 0.f;

    juce::dsp::DelayLine<float> pdL, pdR;
    juce::dsp::DelayLine<float> pdDryL, pdDryR;
    ...
    float  lfL = 0.f, lfR = 0.f;
    float  xfL = 0.f, xfR = 0.f;
    float  lfoPhase = 0.f;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MetallicDDProcessor)
};
